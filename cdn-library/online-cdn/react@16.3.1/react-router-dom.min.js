!(function (t, e) {
    ...
    var h = r(function (t) {
        t.exports = (function () {
            ...
            return (n.checkPropTypes = c), (n.PropTypes = n);
        })();
    }),
        u = "__global_unique_id__",
        d = function () {
            return (e[u] = (e[u] || 0) + 1);
        };
    function s(t) {
    ...
    var f = function () { };
    (f.thatReturns = s),
        (f.thatReturnsFalse = s(!1)),
        (f.thatReturnsTrue = s(!0)),
        (f.thatReturnsNull = s(null)),
        (f.thatReturnsThis = function () {
            return this;
        }),
        (f.thatReturnsArgument = function (t) {
            return t;
        });
    var v = f,
        l = r(function (t, e) {
            ...
            (e.default = function (t, a) {
                var e,
                    n,
                    r = "__create-react-context-" + (0, u.default)() + "__",
                    o = (function (c) {
                        function u() {
                            var t, e, n, r;
                            s(this, u);
                ...
                o.childContextTypes =
                    (((e = {})[r] = c.default.object.isRequired), e);
                var i = (function (i) {
                    function a() {
                        var t, n;
                        s(this, a);
                        ...
                        return (
                            ((t = n =
                                f(
                                    this,
                                    i.call.apply(i, [this].concat(r))
                                )).state = { value: n.getValue() }),
                ...
                return (
                    (i.contextTypes = (((n = {})[r] = c.default.object), n)),
    ...
    function R(t) {
        ...
        var d = j(u, 0, a.length - 1),
            v = a.map(function (t) {
                return C(t, void 0, "string" == typeof t ? h() : t.key || h());
            }),
            y = E;
        function m(t) {
            var e = j(g.index + t, 0, g.entries.length - 1),
                n = g.entries[e];
            l.confirmTransitionTo(n, "POP", o, function (t) {
                t ? p({ action: "POP", location: n, index: e }) : p();
            });
        }
        var g = {
            length: v.length,
            ...
            createHref: y,
            push: function (t, e) {
                var r = C(t, e, h(), g.location);
                l.confirmTransitionTo(r, "PUSH", o, function (t) {
                    if (t) {
                        var e = g.index + 1,
                            n = g.entries.slice(0);
            ...
            replace: function (t, e) {
                var n = "REPLACE",
                    r = C(t, e, h(), g.location);
                l.confirmTransitionTo(r, n, o, function (t) {
                    t &&
                        ((g.entries[g.index] = r),
    ...
    function F(f) {
        ...
        return function (t, e) {
            for (
                var n = "",
                r = t || {},
                o = (e || {}).pretty ? I : encodeURIComponent,
                i = 0;
                i < f.length;
                i++
            ) {
    ...
    (_.parse = T),
        (_.compile = A),
        (_.tokensToFunction = M),
        (_.tokensToRegExp = U);
    var q = r(function (t, e) {
    ...
    var rt = function t(e, n, r) {
        ...
        Z && (i = i.concat(Z(n)));
        for (
            var a = G[e.$$typeof] || Y, c = G[n.$$typeof] || Y, u = 0;
            u < i.length;
            ++u
        ) {
            var s = i[u];
        ...
        it = (function (n) {
            ...
            return (
                ...
                (e.render = function () {
                    return y.createElement(ot.Provider, {
        ...
        at = (function (o) {
            function t() {
                for (
                    ...
                    n[r] = arguments[r];
                return (
                    ((t = o.call.apply(o, [this].concat(n)) || this).history =
                        R(t.props)),
                    t
                );
            }
        ...
        ct = (function (t) {
            ...
            return (
                ...
                (n.componentDidUpdate = function (t) {
                    this.props.onUpdate &&
                        this.props.onUpdate.call(this, this, t);
                }),
    ...
    var yt = (function (t) {
        ...
        return (
            ...
            (e.prototype.render = function () {
                var u = this;
                return y.createElement(ot.Consumer, null, function (t) {
                    t || P(!1);
                    var e,
                        n = u.props.location || t.location,
                        r = b({}, t, {
                            location: n,
                            match: u.props.computedMatch
                                ? u.props.computedMatch
                                : u.props.path
                                    ? vt(n.pathname, u.props)
                                    : t.match,
                        }),
                        o = u.props,
                        i = o.children,
    ...
    var Ot = (function (o) {
        function t() {
            ...
            return (
                ((e =
                    o.call.apply(o, [this].concat(n)) || this).handlePush =
                    function (t) {
        ...
        xt = (function (t) {
            ...
            return (
                ...
                (e.prototype.render = function () {
                    var t = this;
                    return y.createElement(ot.Consumer, null, function (n) {
                        n || P(!1);
                        var r,
                            o,
                            i = t.props.location || n.location;
                        return (
                            y.Children.forEach(t.props.children, function (t) {
                                if (null == o && y.isValidElement(t)) {
    ...
    var Rt = "Invariant failed";
    function kt(t, e) {
        if (!t) throw new Error(Rt);
    }
    function _t(t) {
        return "/" === t.charAt(0) ? t : "/" + t;
    }
    ...
    function $t(t, e) {
        return (
            ...
            (function n(e, r) {
                ...
                var t = void 0 === e ? "undefined" : jt(e);
                if (t !== (void 0 === r ? "undefined" : jt(r))) return !1;
                if ("object" !== t) return !1;
                var o = e.valueOf(),
                    i = r.valueOf();
                if (o !== e || i !== r) return n(o, i);
    ...
    function Vt(t) {
        ...
        var e,
            ...
            u =
                ((-1 ===
                    (e = window.navigator.userAgent).indexOf("Android 2.") &&
        ...
        function y(t) {
            Et(R, t),
                (R.length = c.length),
                v.notifyListeners(R.location, R.action);
        }
        function m(t) {
        ...
        function w(e) {
            if (b) (b = !1), y();
                ...
                v.confirmTransitionTo(e, "POP", f, function (t) {
                    t
        ...
        function S(t) {
            1 === (C += t) && 1 === t
                ? (window.addEventListener(Ht, m),
                    n && window.addEventListener(Bt, g))
                : 0 === C &&
                (window.removeEventListener(Ht, m),
                    n && window.removeEventListener(Bt, g));
        }
        var j = !1;
        var R = {
            length: c.length,
            ...
            createHref: P,
            push: function (t, e) {
                var a = Lt(t, e, d(), R.location);
                v.confirmTransitionTo(a, "PUSH", f, function (t) {
                    if (t) {
                        var e = P(a),
                            n = a.key,
                            r = a.state;
            ...
            replace: function (t, e) {
                var i = "REPLACE",
                    a = Lt(t, e, d(), R.location);
                v.confirmTransitionTo(a, i, f, function (t) {
                    if (t) {
                        var e = P(a),
                            n = a.key,
                            r = a.state;
                        if (u)
                            if (
                                (c.replaceState({ key: n, state: r }, null, e),
                                    s)
                            )
        ...
        Wt = {
            hashbang: {
                encodePath: function (t) {
                    return "!" === t.charAt(0) ? t : "!/" + Tt(t);
                },
                decodePath: function (t) {
                    return "!" === t.charAt(0) ? t.substr(1) : t;
                },
            },
            noslash: { encodePath: Tt, decodePath: _t },
            slash: { encodePath: _t, decodePath: _t },
        };
    function Kt() {
    ...
    function Yt(t) {
        ...
        var e = window.history,
            ...
            o = n.hashType,
            i = void 0 === o ? "slash" : o,
            u = t.basename ? Mt(_t(t.basename)) : "",
            a = Wt[i],
            s = a.encodePath,
            f = a.decodePath;
        function l() {
            var t = f(Kt());
            return u && (t = At(t, u)), Lt(t);
        }
        var p = It();
        function h(t) {
            Et(C, t),
        ...
        var C = {
            ...
            push: function (t, e) {
                var a = Lt(t, void 0, void 0, C.location);
                p.confirmTransitionTo(a, "PUSH", c, function (t) {
                    if (t) {
                        var e,
                            n = Ut(a),
                            r = s(u + n);
                        if (Kt() !== r) {
                            (v = n), (e = r), (window.location.hash = e);
                            var o = w.lastIndexOf(Ut(C.location)),
                                i = w.slice(0, -1 === o ? 0 : o + 1);
                            i.push(n),
                                (w = i),
                                h({ action: "PUSH", location: a });
                        } else h();
                    }
                });
            },
            replace: function (t, e) {
                ...
                p.confirmTransitionTo(i, o, c, function (t) {
                    if (t) {
                        var e = Ut(i),
                            n = s(u + e);
                        Kt() !== n && ((v = e), Jt(n));
                        var r = w.indexOf(Ut(C.location));
                        -1 !== r && (w[r] = e), h({ action: o, location: i });
                    }
                });
            },
            go: O,
    ...
    r(function (t) {
        t.exports = (function () {
            ...
            return (n.checkPropTypes = Xt), (n.PropTypes = n);
        })();
    });
    var Zt = (function (o) {
        function t() {
        ...
        return (
            ...
            (n.render = function () {
                var r = this,
                    ...
                    o = t.innerRef,
                    i = (t.replace, t.to),
                    a = ee(t, ["innerRef", "replace", "to"]);
                return y.createElement(ot.Consumer, null, function (e) {
                    e || kt(!1);
                    var t =
                        "string" == typeof i
                            ? Lt(i, null, null, e.location)
                            : i,
                        n = t ? e.history.createHref(t) : "";
                    return y.createElement(
                        "a",
                        Et({}, a, {
                            onClick: function (t) {
                                return r.handleClick(t, e.history);
                            },
                            href: n,
                            ref: o,
                        })
    ...
    (t.BrowserRouter = Zt),
        ...
        (t.NavLink = function (t) {
            var e = t["aria-current"],
                ...
                d = "object" == typeof p ? p.pathname : p,
                v = d && d.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1");
                    ...
                    o = C(
                        i
                            ? "string" == typeof a
                                ? lt(a, i.params)
                                : b({}, a, {
                                    pathname: lt(a.pathname, i.params),
                                })
                            : a
                    );
                return n
        ...
        (t.withRouter = function (r) {
            var t = function (t) {
                ...
                return y.createElement(yt, {
                    children: function (t) {
                        return y.createElement(r, b({}, n, t, { ref: e }));
                    },
                });
            };
            return (
                (t.displayName =
                    "withRouter(" + (r.displayName || r.name) + ")"),

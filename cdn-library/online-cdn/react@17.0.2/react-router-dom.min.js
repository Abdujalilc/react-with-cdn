!(function (t, n) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : n(((t = t || self).ReactRouterDOM = {}), t.React);
})(this, function (t, C) {
    "use strict";
    function e(t, n) {
        return (e =
    ...
    function w(t) {
        ...
        function v(t) {
            T(R, t),
                (R.length = c.length),
                d.notifyListeners(R.location, R.action);
        }
        function y(t) {
            !(function (t) {
        ...
        function E(t) {
            1 === (C += t) && 1 === t
                ? (window.addEventListener(N, y),
                  n && window.addEventListener(H, m))
                : 0 === C &&
                  (window.removeEventListener(N, y),
                  n && window.removeEventListener(H, m));
        }
        var S = !1;
        var R = {
            length: c.length,
            ...
            replace: function (t, n) {
                ...
                d.confirmTransitionTo(a, i, f, function (t) {
                    if (t) {
                        ...
                        if (u)
                            if (
                                (c.replaceState({ key: e, state: r }, null, n),
                                s)
                            )
                ...
                p.confirmTransitionTo(i, o, a, function (t) {
                    if (t) {
                        var n = _(i),
                            e = s(c + n);
                        D() !== e && ((v = n), W(e));
                        var r = b.indexOf(_(E.location));
                        -1 !== r && (b[r] = n), h({ action: o, location: i });
                    }
                });
            },
            go: x,
        ...
        Pt = (function (o) {
            function t() {
                for (
                    ...
                    e[r] = arguments[r];
                return (
                    ((t = o.call.apply(o, [this].concat(e)) || this).history =
                        (function (t) {
                            void 0 === t && (t = {});
                            var n = t,
    ...
    var Ft = (function (o) {
            function t() {
                for (
                    var n, t = arguments.length, e = new Array(t), r = 0;
                    r < t;
                    r++
                )
                    e[r] = arguments[r];
                return (
                    ((n =
                        o.call.apply(o, [this].concat(e)) || this).handlePush =
                        function (t) {
    ...
    var Qt = Yt(function (t, f) {
        ...
        return C.createElement(bt.Consumer, null, function (t) {
            ...
            return (
                Kt !== Yt ? (s.ref = f || P) : (s.innerRef = P),
                C.createElement(Gt, s)
            );
        });
    });
    (t.BrowserRouter = Vt),
        ...
        (t.withRouter = function (r) {
            function t(t) {
                ...
                return C.createElement(bt.Consumer, null, function (t) {
                    return (
                        t || k(!1), C.createElement(r, T({}, e, t, { ref: n }))
                    );
                });
            }
